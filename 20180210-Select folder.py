...
b1 = tk.Button(window, text='Select folder', command=lambda:
               select_folder(folder_name_tk))
b1.pack()

folder_name_tk = tk.StringVar()
lb_folder = tk.Label(window, textvariable=folder_name_tk, bg='Yellow',
                     width=200)
lb_folder.pack()
...
b_load_folder = tk.Button(window, text='Load folder',
                          command=lambda:
                              load_folder(folder_name_tk, sample_list_Text))
b_load_folder.pack()
